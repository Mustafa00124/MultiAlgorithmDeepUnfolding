...
parser.add_argument('--file_write', type=str, default= './Madu_Results.csv')
parser.add_argument('--layer_list', type=lambda s: [item for item in s.split(',')], default=['Mean2_Layer','Median2_Layer'], help='List of layer names separated by comma')
parser.add_argument('--writecsv', action='store_true', help='Flag to write results to CSV')
parser.add_argument('--name', type=str, default='refRPCA_CDnet')
...
parser.add_argument('--log-dir', default='./logs/cdnet/highway/')
